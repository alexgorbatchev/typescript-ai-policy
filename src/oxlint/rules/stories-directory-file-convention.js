import { isInStoriesDirectory, readPathFromStoriesDirectory } from "./helpers.js";
...
function isAllowedStoriesDirectoryPath(relativePath) {
...
const storiesDirectoryFileConventionRule = {
  meta: {
