import { hasBaseName, readDeclarationIdentifierNames, readLiteralStringValue } from "./helpers.js";
...
function isTypeExportSpecifier(specifier, exportDeclaration) {
  return exportDeclaration.exportKind === "type" || specifier.exportKind === "type";
}

const noTypeExportsFromConstantsRule = {
  meta: {
