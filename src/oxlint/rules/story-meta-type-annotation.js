import { unwrapExpression } from "./helpers.js";
...
function readTopLevelVariableDeclarator(program, name) {
...
function isMetaTypeReference(typeAnnotation) {
...
function readMetaAssertionTypeAnnotation(expression) {
...
const storyMetaTypeAnnotationRule = {
  meta: {
